      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Link your Google Classroom account to start automating your workflow
            and managing assignments efficiently with ClassGo.
          </p>
        </div>
          ...
          <Card className="border-border bg-card">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-muted-foreground">
                We&apos;ll securely connect to your Google Classroom account
              ...
              <CardContent className="flex items-start space-x-3 p-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    View and manage your classroom courses
                  </p>
                </div>
              </CardContent>
            </Card>
