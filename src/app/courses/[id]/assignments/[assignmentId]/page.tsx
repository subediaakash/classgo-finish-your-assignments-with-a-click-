...
export default function AssignmentDetailsPage({ params }: PageProps) {
    ...
    useEffect(() => {
        async function fetchAssignmentData() {
            ...
            setDataLoading(true);
            try {
                const res = await fetch(`/api/classroom/${courseId}/assignments/${assignmentId}`, {
                    method: "GET",
                    headers: {
                ...
                if (!res.ok) {
                    ...
                    setError(`Failed to fetch assignment data: ${data.error || 'Unknown error'}`);
                    return;
                }
                    ...
                    <div>
                                ...
                                <div className="flex-1">
                                    ...
                                    {assignmentData.assignment.dueDate && (
                                        <div className="flex items-center text-gray-600">
                                            ...
                                            <span>
                                                Due: {new Date(assignmentData.assignment.dueDate.year, assignmentData.assignment.dueDate.month - 1, assignmentData.assignment.dueDate.day).toLocaleDateString()}
                                                {assignmentData.assignment.dueTime &&
                                                    assignmentData.assignment.dueTime.hours !== undefined &&
                                                    assignmentData.assignment.dueTime.minutes !== undefined && (
                                                        <span className="ml-2">
                                                            at {assignmentData.assignment.dueTime.hours.toString().padStart(2, '0')}:{assignmentData.assignment.dueTime.minutes.toString().padStart(2, '0')}
                                                        </span>
                                                    )}
                                            </span>
                                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
                            <div className="bg-white rounded-lg shadow p-6">
                                <div className="text-2xl font-bold text-blue-600">{assignmentData.statistics.totalSubmissions}</div>
                                <div className="text-sm text-gray-600">Total Submissions</div>
                            </div>
                            <div className="bg-white rounded-lg shadow p-6">
                                <div className="text-2xl font-bold text-green-600">{assignmentData.statistics.submittedCount}</div>
                                <div className="text-sm text-gray-600">Submitted</div>
                            </div>
                            <div className="bg-white rounded-lg shadow p-6">
                                <div className="text-2xl font-bold text-yellow-600">{assignmentData.statistics.draftCount}</div>
                                <div className="text-sm text-gray-600">Drafts</div>
                            </div>
                            <div className="bg-white rounded-lg shadow p-6">
                                <div className="text-2xl font-bold text-red-600">{assignmentData.statistics.lateSubmissions}</div>
                                <div className="text-sm text-gray-600">Late</div>
                            </div>
                            <div className="bg-white rounded-lg shadow p-6">
                                <div className="text-2xl font-bold text-purple-600">{assignmentData.statistics.gradedCount}</div>
                                        ...
                                        <div key={submission.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                                            ...
                                            <div className="flex items-center justify-between mb-4">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <div className="text-lg font-semibold text-gray-900">
                                                            {submission.userProfile?.name?.fullName || 'Unknown Student'}
                                                        </div>
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStateColor(submission.state)}`}>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-sm text-gray-500">
                                                        {new Date(submission.updateTime).toLocaleTimeString()}
                                                    </div>
                                                </div>
                                                <div>
                                            ...
                                            <div>
                                                <div className="text-sm font-medium text-gray-500 mb-2">Submission Files & Content</div>
